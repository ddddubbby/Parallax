...
| A4 | ACP contract addresses, fee bps, pause state match expectations | Live-chain reads; mutable by design | M35 (8)(9) snapshot + every startup/readiness check | Admissions freeze until reviewed |
...
| A8 | Graduation rules (10 sandbox jobs, ≤ 6 tests, ~5–10 day review, refunds of unused test funds) | Reviewer-read docs; live links 404 via tooling | M42 entry (re-verified against live docs) | Re-plan M42's external track; engineering completion unaffected |
