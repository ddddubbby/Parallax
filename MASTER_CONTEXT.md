...
| `M47_BUILD_PLAN.md` | ACTIVE | M47 transition feedback and refresh cleanup (D-118): reachable route loading, same-segment pending tabs, redundant refresh removal |
...
| `PRD.md` | ACTIVE | Resonance audit+simulation contract through M34A, M43–M46 delivered scope, and M47/D-118 transition feedback + refresh cleanup |
