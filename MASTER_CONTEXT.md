...
| `M53_BUILD_PLAN.md` | ACTIVE | M53 sample terminology clarity (D-123): operator-facing Sample size and Repeats per prompt labels |
...
| `PRD.md` | ACTIVE | Resonance Evidence and Message Lift contract through M53/D-123 |
