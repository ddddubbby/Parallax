> LIFECYCLE: HISTORICAL · ROLE: CANON · OWNS: product contract for `resonance_geo_v1` — input schema, prompt matrix, extraction rules, metrics, exclusions · DISPOSITION: SUPERSEDED BY D-141 (GEO agent retired; code, tables and dependency removed in M62)
