...
const report: FramingReportModel = {
  ...
  discoveryManifestDigest: "abc123",
  discoveryAttestation: "The reviewer attested that in-product positioning and fact-sheet material was not consulted before codebook lock.",
  codebookLockedAt: "2026-07-11T01:00:00.000Z",
  revealedAt: "2026-07-11T02:00:00.000Z",
  codebook: [{ associationId: "durability", label: "Durability", definition: "Product durability." }],
  gapOutcome: "actionable_gap_identified",
  reviewOutcomeCounts: { coded: 2, none: 3, unavailable: 1 },
  denominator: 6,
  ...
  evidence: [{ responseId: "response-1", rawText: "A durable camera.", associationLabel: "Durability", quote: "durable camera", startOffset: 2, endOffset: 16, variantKey: "a1", providerId: "mock", modelVersion: "v1", generationMode: "ungrounded", observedAt: "2026-07-11T00:00:00.000Z" }],
