...
export const GLOSSARY_TERMS: Record<string, string> = {
  ...
  "simulated (sim)": "A Message Lift result produced by simulated responses, not measured human behavior or observed AI visibility data. Simulated rows never mix with audit metrics.",
};
