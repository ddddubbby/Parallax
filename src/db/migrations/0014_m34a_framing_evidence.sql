...
ALTER TABLE "prompt_cells" ADD CONSTRAINT "prompt_cells_audit_resonance_shape_ck" CHECK (("prompt_cells"."intent" = 'simulation' and "prompt_cells"."persona_id" is null and "prompt_cells"."market_id" is null and "prompt_cells"."stimulus_id" is not null and "prompt_cells"."panel_persona_key" is not null) or ("prompt_cells"."intent" = 'representation' and "prompt_cells"."persona_id" is null and "prompt_cells"."market_id" is null and "prompt_cells"."stimulus_id" is null and "prompt_cells"."panel_persona_key" is null) or ("prompt_cells"."intent" not in ('simulation', 'representation') and "prompt_cells"."stimulus_id" is null and "prompt_cells"."panel_persona_key" is null));
